function compare_examcards(source_examcard, target_examcard)
...
%% Convert to table
results = cell2table(compare_fields, 'VariableNames', header_names);

%% Write out as csv
filename = fullfile(pwd, ['compare_examcards_', datestr(now, 'ddmmmyyyy'), '.csv']);
